            ...
            getSelectedItem: function () {
                if (this.FieldRendering !== null) {
                    if (this.ItemsDropList.SelectedItem !== "") {
                        ...
                        this.SelectedItem = { Catalog: this.ItemsDropList.SelectedItem.catalogname, ItemSKU: this.ItemsDropList.SelectedItem.name, Variant: this.VariantsListBox.SelectedItems[0].Name == "-" ? "" : this.VariantsListBox.SelectedItems[0].Name };
